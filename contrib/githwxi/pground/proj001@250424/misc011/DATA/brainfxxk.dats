...
(*
HX-2026-01-14:
Wed Jan 14 08:21:27 PM EST 2026
The following code was written
by Gavin Zhao around January, 2025
https://github.com/GZGavinZhao
The code implements an interpreter
for the brainfxxk language.
This is a good example showing the
need for tail-recursion optimization
(TRO).
HX-2026-01-14:
Wed Jan 14 08:33:07 PM EST 2026
I tested it on the hello.bf program
and it worked after I set the stack-size
to something like 1500. This is due to
xats2js_jsemit01 not performing TRO yet.
BTW, there is no plan to add TRO support
into xats2js_jsemit01 at this moment.
*)
(* ****** ****** *)
(* ****** ****** *)
