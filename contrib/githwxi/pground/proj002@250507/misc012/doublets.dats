...
//
end(*let*)//end-of-[doublets_solve(wd1,wd2)]
//
(* ****** ****** *)
(* ****** ****** *)
//
#extern
fun
DATS_doublets_solve$show
( wd1: strn
, wd2: strn) : void = $extnam()
//
(* ****** ****** *)
//
#implfun
...
strmcon_vt_nil
((*void*)) =>
printsln("No doublets!")
| ~
strmcon_vt_cons
(ws, paths) =>
(g_free(ps); printsln("Yes: ", ws)))
end(*let*)//end-of-[doublets_solve$show(wd1,wd2)]
//
(* ****** ****** *)
(* ****** ****** *)
//
(*
val () = DATS_doublets_solve$show("flour", "bread")
*)
//
(* ****** ****** *)
(* ****** ****** *)
